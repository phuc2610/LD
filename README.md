...
|---|---|---|---|
| POST | /api/ai/chat | GET | /api/ai/chat/history |
| POST | /api/ai/medication/parse | POST | /api/ai/meal/estimate |
| POST | /api/ai/disease/identify | POST | /api/ai/health/recommendations |
| POST | /api/ai/report/analyze | POST | /api/ai/medication/suggest |
| POST | /api/ai/medication/interactions | POST | /api/alerts/analyze-all |
| POST | /api/alerts/analyze/:patientId | GET | /api/alerts/doctor/summary |
| GET | /api/alerts/patient/:patientId | PATCH | /api/alerts/:alertId/read |
| PATCH | /api/alerts/patient/:patientId/read-all | POST | /api/alerts/sos |
| POST | /api/appointments | GET | /api/appointments |
| PATCH | /api/appointments/:id | DELETE | /api/appointments/:id |
| POST | /api/auth/register | POST | /api/auth/send-register-otp |
| POST | /api/auth/verify-register-otp | POST | /api/auth/login |
| POST | /api/auth/forgot-password | POST | /api/auth/verify-forgot-otp |
| POST | /api/auth/reset-password | GET | /api/auth/profile |
| POST | /api/auth/change-password | POST | /api/auth/delete-account |
| POST | /api/caregiver/link/request | POST | /api/caregiver/link/accept |
| GET | /api/caregiver/requests | POST | /api/caregiver/requests/respond |
| GET | /api/caregiver/patients | GET | /api/caregiver/patients/:patientId |
| GET | /api/caregiver/patients/:patientId/today-status | GET | /api/caregiver/alerts |
| PATCH | /api/caregiver/alerts/:alertId/read | GET | /api/caregiver/patients/:patientId/medications/timeline |
| GET | /api/caregiver/patients/:patientId/medications/week-history | GET | /api/caregiver/patients/:patientId/medications/adherence |
| GET | /api/caregiver/patients/:patientId/health/daily | GET | /api/caregiver/patients/:patientId/appointments |
| GET | /api/caregiver/patients/:patientId/notes | POST | /api/caregiver/patients/:patientId/notes |
| GET | /api/caregiver/patients/:patientId/location | GET | /api/caregiver/patients/:patientId/emergency-contacts |
| GET | /api/caregiver/patients/:patientId/tasks | POST | /api/caregiver/patients/:patientId/tasks/:taskId/notify |
| POST | /api/chat/send | GET | /api/chat/conversations |
| GET | /api/chat/messages/:otherUserId | PATCH | /api/chat/messages/:messageId/read |
| GET | /api/chat/unread-count | POST | /api/custom-reminders |
| GET | /api/custom-reminders | PATCH | /api/custom-reminders/:id |
| DELETE | /api/custom-reminders/:id | GET | /api/doctors/profile |
| POST | /api/doctors/link | POST | /api/doctors/revoke/:doctorId |
| GET | /api/doctors/my-doctors | GET | /api/doctors/patients |
| GET | /api/doctors/patients/:patientId/profile | GET | /api/doctors/patients/:patientId/vitals |
| POST | /api/doctors/patients/:patientId/prescriptions | GET | /api/doctors/patients/:patientId/adherence |
| GET | /api/doctors/patients/:patientId/prescription-history | GET | /api/doctors/patients/:patientId/symptom-trend |
| GET | /api/drug-catalog | GET | /api/drug-catalog/search |
| POST | /api/drug-catalog | PATCH | /api/drug-catalog/:id |
| DELETE | /api/drug-catalog/:id | POST | /api/drug-catalog/seed |
| POST | /api/health/logs | GET | /api/health/summary |
| GET | /api/health/scheduled | GET | /api/health/today |
| PATCH | /api/health/logs/:id | DELETE | /api/health/logs/:id |
| GET | /api/medical-records/patient/my-records | GET | /api/medical-records/:patientId |
| POST | /api/medical-records/:patientId | GET | /api/medical-records/:patientId/:recordId/pdf |
| GET | /api/medical-records/:patientId/:recordId | PATCH | /api/medical-records/:patientId/:recordId |
| POST | /api/medications | POST | /api/medications/take-all-now |
| GET | /api/medications/today | GET | /api/medications/missed |
| GET | /api/medications | PATCH | /api/medications/:id/take |
| PATCH | /api/medications/reminders/:id | DELETE | /api/medications/batch |
| DELETE | /api/medications/reminders/:id | DELETE | /api/medications/:id |
| POST | /api/prescriptions/scan | POST | /api/prescriptions |
| GET | /api/prescriptions | GET | /api/prescriptions/:id |
| PUT | /api/prescriptions/:id | DELETE | /api/prescriptions/:id |
| GET | /api/reports/overview | GET | /api/reports/export-pdf |
| GET | /api/settings/notifications | PATCH | /api/settings/notifications |
| GET | /api/settings/medication-times | PATCH | /api/settings/medication-times |
| POST | /api/upload/image | GET | /api/users/me |
| PATCH | /api/users/me | POST | /api/wellness/log |
